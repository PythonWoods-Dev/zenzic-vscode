...
- **Minimum Core Baseline**: Currently pinned to **Zenzic Core `v0.27.2`** (`MIN_CORE_VERSION = '0.27.2'` in `src/extension.ts`).
...
| **Zenzic Core** | ≥ 0.27.2 | Core engine (`uv tool install zenzic`) |
