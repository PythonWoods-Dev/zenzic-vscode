...
- **Minimum Core Baseline**: Currently pinned to **Zenzic Core `v0.28.1`** (`MIN_CORE_VERSION = '0.28.1'` in `src/extension.ts`).
...
| **Zenzic Core** | ≥ 0.28.1 | Core engine (`uv tool install zenzic`) |
