...
- **Minimum Core Baseline**: Currently pinned to **Zenzic Core `v0.29.0`** (`MIN_CORE_VERSION = '0.29.0'` in `src/extension.ts`).
...
| **Zenzic Core** | ≥ 0.29.0 | Core engine (`uv tool install zenzic`) |
