...
![Zenzic in VS Code: an empty Markdown link is underlined as a Z108 error, Ctrl+. applies the quick fix that inserts a TODO placeholder, the placeholder is itself flagged Z501, and typing real link text leaves the file with zero findings](images/demo.gif)
